<div class="flex flex-col mr-2 py-10 gap-4 text-2xl" dir="rtl">
    ...
    <a href="/myactvities" class="flex items-center gap-2">
...
@endauth
    ...
    {{-- <a href="/" class="flex items-center gap-2">
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-bell"
            viewBox="0 0 16 16">
            <path
                d="M8 16a2 2 0 0 0 2-2H6a2 2 0 0 0 2 2M8 1.918l-.797.161A4 4 0 0 0 4 6c0 .628-.134 2.197-.459 3.742-.16.767-.376 1.566-.663 2.258h10.244c-.287-.692-.502-1.49-.663-2.258C12.134 8.197 12 6.628 12 6a4 4 0 0 0-3.203-3.92zM14.22 12c.223.447.481.801.78 1H1c.299-.199.557-.553.78-1C2.68 10.2 3 6.88 3 6c0-2.42 1.72-4.44 4.005-4.901a1 1 0 1 1 1.99   </script>
</head>
...
<body class="font-sans antialiased bg-white">
    ...
    @livewireScripts
     ...
     <a href="/{{auth()->user()->id}}/bookmarks" class="flex items-center gap-2">
