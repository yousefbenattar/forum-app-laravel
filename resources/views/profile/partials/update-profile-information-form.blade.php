<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6" enctype="multipart/form-data">
        @csrf
        @method('patch')
        <img src="{{ auth()->user()->avatar ? Storage::url(auth()->user()->avatar) : asset("images/profile.png")}}"
        ...
        <textarea id="bio" name="bio" class="mt-1 block w-full" rows="3"
            placeholder="أخبرنا عن نفسك...">{{ old('bio', $user->bio) }}</textarea>
                ...
                <div>
                    <p class="text-sm mt-2 text-gray-800 dark:text-gray-200">
                        ...
                        <button form="send-verification"
                            ...
                            {{ __('انقر هنا لإعادة إرسال بريد التفعيل الإلكتروني.') }}
                        </button>
                    </p>
