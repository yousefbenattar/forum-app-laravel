   ...
   <div class="space-y-4">
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $activities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
        <div class="mt-1 p-4 bg-white shadow rounded-lg flex items-center gap-2" dir="rtl">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php switch($activity->type):
                    case ('posted'): ?>
                        <p>لقد قمت بنشر منشور جديد : <strong><?php echo e($activity->subject->title); ?></strong></p>
                        <?php break; ?>
                    <?php case ('liked'): ?>
                        <p>
        لقد أعجبك منشور: 
        <strong><?php echo e($activity->subject?->post?->title ?? 'منشور غير موجود'); ?></strong>
    </p>  <?php break; ?>
                    <?php case ('commented'): ?>
                        <p>لقد علّقت: <em>"<?php echo e(Str::limit( $activity->subject->content, 50)); ?>"</em></p>
                        <?php break; ?>
                    <?php case ('followed'): ?>
...
<?php endif; ?><?php /**PATH E:\Laravel-2026\forum\resources\views/user/activity.blade.php ENDPATH**/ ?>