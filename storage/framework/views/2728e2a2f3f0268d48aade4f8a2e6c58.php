...
<a href="<?php echo e(route('posts.show', $post->id)); ?>" class="group" dir="rtl">
    <div
        ...
        <div class="flex-1 pt-6 px-4 text-right">
            ...
            <p class="text-gray-600 mb-4">
                <?php echo e(Str::limit($post->content, 70)); ?>
        ...
        <div class="flex flex-row items-center justify-between gap-6 p-4 border-r border-gray-100">
            ...
            <div class="flex flex-row items-center gap-2">
                ...
                <p><?php echo e($post->comments?->count() ?? 0); ?></p>
            </div>
            ...
            <div class="flex flex-row items-center gap-2">
                ...
                <p><?php echo e($post->view_count ?? 0); ?></p>
            </div>
        </div>
    </div>
</a>
